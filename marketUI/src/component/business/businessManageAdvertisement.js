...
function BusinessManageAdvertisement() {
  return (
    <div className="App">
...
<meta httpEquiv="Content-Type" content="text/html; charset=utf-8" />
  ...
  <title>Manage Ads - Business</title>
  ...
  <div >
    <div  className="row">
      <div style={{ width: "50%" }} className="column">
        <div className="card">
        <Link to={"/businessaddadvertisement"} style={{textDecoration:"none",position:"absolute",height:"100%",width:"100%"}}>

          <h5 style={{fontSize:"2rem"}}> Add Advertisments</h5>
          <img
            onclick="myfunction()"
            style={{ width: "97%" }}
            src="images/AddAd - Copy.png"
          /></Link>
      ...
      <div style={{ display: "contents" }} className="column">
        <div className="card">
        <Link to={"/businessremoveadvertisement"} style={{textDecoration:"none",position:"absolute",height:"100%",width:"100%"}}>

          <h5 style={{fontSize:"2rem"}}> Remove Advertisements</h5>
          <img
            onclick="myfunction1()"
            style={{ width: "88%" }}
            src="images/removead - Copy.png"
          /></Link>
...
export default BusinessManageAdvertisement;
