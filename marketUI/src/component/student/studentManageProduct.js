...
function StudentManageProduct() {
  ...
  <title>manage product student</title>
  ...
  <div className="bg-img">
    <div className="row">
      ...
      <Link to={"/studentremoveproduct"} > 
        <div style={{marginLeft:"44%"}} className="card">
          <h5 style={{ textAlign: "center" }}>
            {" "}
            <b>Remove products</b>
          </h5>
          
          <img onclick="myfun1()" src="images/remove.png" />
...
export default StudentManageProduct;
