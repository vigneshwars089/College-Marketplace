...
function removeClub(e){
  ...
  const fetchData1 = async () => {
    try{
      const res= await axios.post('http://localhost:8000/api/removeclub',null, {params: {
    ...
    alert("removed the club successfully");
    }
    fetchData1();
// e.preventDefault();
}
  ...
  />
  <title>Manage Clubs - School Admin</title>
  <style
        ...
        <table className="styled-table" id="visitor-table">
          ...
          {content.map(c => (  <tr>
              ...
              <td>
                ...
                <button name={c.clubName} onClick={removeClub} type="button" className="btn update-button">
                  Delete
                </button>
              </td>
            </tr>))}
...
export default SuperAdminManageClub;
