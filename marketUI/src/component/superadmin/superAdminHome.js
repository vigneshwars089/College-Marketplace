  ...
  <div style={{overflow:"inherit",
    ...
    <div className="contents">
      <div className="content-div">
        <a href="/superadminmanagestudent">
          <div className="single-option">Manage Students</div>
        </a>
        <a href="/superadminmanagebusiness">
          <div className="single-option">Manage BusinessOwner</div>
        </a>
        <a href="/superadminmanageschooladmin">
          <div className="single-option">Manage schoolAdmin</div>
        </a>
      </div>
      <div className="content-div">
        <a href="/superadminmanageclub">
          <div className="single-option">Moderate clubs</div>
        </a>
        <a href="/superadminmanagepost">
          <div className="single-option">Moderate Posts</div>
        </a>
        <a href="/superadminviewreport">
